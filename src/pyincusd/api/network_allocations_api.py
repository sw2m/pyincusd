...
class NetworkAllocationsApi:
    ...
    async def network_allocations_get(
        ...
        :type project: str
        :param all_projects: Retrieve entities from all projects
        ...
        _param = self._network_allocations_get_serialize(
            project=project,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NetworkAllocationsGet200Response",
    ...
    async def network_allocations_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NetworkAllocationsGet200Response]:
        """Get the network allocations in use (`network`, `network-forward` and `load-balancer` and `instance`)
    ...
    def _network_allocations_get_serialize(
        self,
        project,
        all_projects,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1.0/network-allocations',
