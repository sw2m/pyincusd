...
class InstanceNvramGuidGetRecursion1200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[Dict[str, InstanceNVRAMVariable]] = Field(default=None, description="Namespaced UEFI variables")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.metadata:
            for _key_metadata in self.metadata:
                _field_dict[_key_metadata] = self.metadata[_key_metadata].to_dict() if self.metadata[_key_metadata] is not None else None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": dict(
                (_k, InstanceNVRAMVariable.from_dict(_v))
