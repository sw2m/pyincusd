...
class NetworkLoadBalancerStateBackendHealth(BaseModel):
    ...
    ports: Optional[List[NetworkLoadBalancerStateBackendHealthPort]] = None
    __properties: ClassVar[List[str]] = ["address", "ports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ports": [NetworkLoadBalancerStateBackendHealthPort.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None
        })
        return _obj
