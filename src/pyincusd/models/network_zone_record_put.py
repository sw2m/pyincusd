...
class NetworkZoneRecordPut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["config", "description", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [NetworkZoneRecordEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
