...
class ResourcesNetworkCardSRIOV(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vfs (list)
        _items = []
        if self.vfs:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current_vfs": obj.get("current_vfs"),
            "maximum_vfs": obj.get("maximum_vfs"),
            "vfs": [ResourcesNetworkCard.from_dict(_item) for _item in obj["vfs"]] if obj.get("vfs") is not None else None
        })
        return _obj

from pyincusd.models.resources_network_card import ResourcesNetworkCard
# TODO: Rewrite to not use raise_errors
ResourcesNetworkCardSRIOV.model_rebuild(raise_errors=False)
