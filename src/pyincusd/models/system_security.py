...
class SystemSecurity(BaseModel):
    ...
    SystemSecurity
    """ # noqa: E501
    config: Optional[SystemSecurityConfig] = None
    state: Optional[SystemSecurityState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": SystemSecurityConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": SystemSecurityState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
