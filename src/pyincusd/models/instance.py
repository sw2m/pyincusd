...
class Instance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["architecture", "config", "created_at", "description", "devices", "disk_only", "ephemeral", "expanded_config", "expanded_devices", "last_used_at", "location", "name", "profiles", "project", "restore", "stateful", "status", "status_code", "type"]
