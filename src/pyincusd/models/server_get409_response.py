...
class ServerGet409Response(BaseModel):
    """
    ServerGet409Response
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["already exists"]})
    error_code: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [409]})
