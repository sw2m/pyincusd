...
class InstanceStateNetwork(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": [InstanceStateNetworkAddress.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            "counters": InstanceStateNetworkCounters.from_dict(obj["counters"]) if obj.get("counters") is not None else None,
