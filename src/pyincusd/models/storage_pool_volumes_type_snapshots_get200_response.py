...
class StoragePoolVolumesTypeSnapshotsGet200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[StrictStr]] = Field(default=None, description="List of endpoints", json_schema_extra={"examples": [["/1.0/storage-pools/local/volumes/custom/foo/snapshots/snap0", "/1.0/storage-pools/local/volumes/custom/foo/snapshots/snap1"]]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StoragePoolVolumesTypeSnapshotsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StoragePoolVolumesTypeSnapshotsGet200Response from a dict"""
        if obj is None:
            return None
