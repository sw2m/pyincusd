...
class DebugKernel(BaseModel):
    """
    DebugKernel
    """ # noqa: E501
    architecture: Optional[StrictStr] = None
    cpu_baseline: Optional[StrictStr] = None
    modules: Optional[List[DebugKernelModule]] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["architecture", "cpu_baseline", "modules", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cpu_baseline": obj.get("cpu_baseline"),
            "modules": [DebugKernelModule.from_dict(_item) for _item in obj["modules"]] if obj.get("modules") is not None else None,
