...
class SystemNetworkWireguardPeer(BaseModel):
    """
    SystemNetworkWireguardPeer
    """ # noqa: E501
    allowed_ips: Optional[List[StrictStr]] = None
    endpoint: Optional[StrictStr] = None
    persistent_keepalive: Optional[StrictInt] = None
    preshared_key: Optional[StrictStr] = None
    public_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["allowed_ips", "endpoint", "persistent_keepalive", "preshared_key", "public_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preshared_key": obj.get("preshared_key"),
