...
class SystemNetworkBridge(BaseModel):
    """
    SystemNetworkBridge
    """ # noqa: E501
    disable_multicast_snooping: Optional[StrictBool] = None
    stp: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["disable_multicast_snooping", "stp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disable_multicast_snooping": obj.get("disable_multicast_snooping"),
            "stp": obj.get("stp")
        })
        return _obj
