...
class InstancesGet200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[StrictStr]] = Field(default=None, description="List of endpoints", json_schema_extra={"examples": [["/1.0/instances/foo", "/1.0/instances/bar"]]})
