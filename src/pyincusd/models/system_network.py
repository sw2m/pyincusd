...
class SystemNetwork(BaseModel):
    ...
    SystemNetwork
    """ # noqa: E501
    config: Optional[SystemNetworkConfig] = None
    state: Optional[SystemNetworkState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": SystemNetworkConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": SystemNetworkState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
