...
class NetworkAllocationsGet200Response(BaseModel):
    """
    NetworkAllocationsGet200Response
    """ # noqa: E501
    metadata: Optional[List[NetworkAllocations]] = Field(default=None, description="List of network allocations used by a consuming entity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [NetworkAllocations.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
