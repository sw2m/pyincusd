...
class SystemKernel(BaseModel):
    """
    SystemKernel
    """ # noqa: E501
    config: Optional[SystemKernelConfig] = None
    state: Optional[SystemKernelState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": SystemKernelConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": SystemKernelState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
