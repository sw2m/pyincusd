...
class NetworkAddressSetsGetRecursion1200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[NetworkAddressSet]] = Field(default=None, description="List of network address sets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [NetworkAddressSet.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
