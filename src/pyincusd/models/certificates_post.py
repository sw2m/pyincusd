...
class CertificatesPost(BaseModel):
    ...
    token: Optional[StrictBool] = Field(default=None, description="Whether to create a certificate add token  API extension: certificate_token", json_schema_extra={"examples": [True]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": obj.get("token"),
            "trust_token": obj.get("trust_token"),
            "type": obj.get("type")
        })
        return _obj
