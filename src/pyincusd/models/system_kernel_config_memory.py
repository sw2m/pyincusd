...
class SystemKernelConfigMemory(BaseModel):
    """
    SystemKernelConfigMemory
    """ # noqa: E501
    persistent_hugepages: Optional[StrictInt] = None
    zram_swap_size: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["persistent_hugepages", "zram_swap_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "persistent_hugepages": obj.get("persistent_hugepages"),
            "zram_swap_size": obj.get("zram_swap_size")
        })
        return _obj
