...
class SystemSecurityConfig(BaseModel):
    ...
    """ # noqa: E501
    custom_ca_certs: Optional[List[StrictStr]] = None
    encryption_recovery_keys: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["custom_ca_certs", "encryption_recovery_keys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "custom_ca_certs": obj.get("custom_ca_certs"),
            "encryption_recovery_keys": obj.get("encryption_recovery_keys")
        })
        return _obj
