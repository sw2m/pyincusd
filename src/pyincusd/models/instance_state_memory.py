...
class InstanceStateMemory(BaseModel):
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total memory size in bytes  API extension: instances_state_total", json_schema_extra={"examples": [12297557]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "swap_usage_peak": obj.get("swap_usage_peak"),
            "total": obj.get("total"),
            "usage": obj.get("usage"),
            "usage_peak": obj.get("usage_peak")
        })
        return _obj
