...
class SystemUpdate(BaseModel):
    ...
    SystemUpdate
    """ # noqa: E501
    config: Optional[SystemUpdateConfig] = None
    state: Optional[SystemUpdateState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": SystemUpdateConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": SystemUpdateState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
