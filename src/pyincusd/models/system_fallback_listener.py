...
from pyincusd.models.system_fallback_listener_state import SystemFallbackListenerState
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class SystemFallbackListener(BaseModel):
    """
    ...
    """ # noqa: E501
    config: Optional[SystemFallbackListenerConfig] = None
    state: Optional[SystemFallbackListenerState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": SystemFallbackListenerConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": SystemFallbackListenerState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
