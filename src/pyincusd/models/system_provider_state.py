...
class SystemProviderState(BaseModel):
    """
    SystemProviderState
    """ # noqa: E501
    registered: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["registered"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SystemProviderState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SystemProviderState from a dict"""
        if obj is None:
            return None
