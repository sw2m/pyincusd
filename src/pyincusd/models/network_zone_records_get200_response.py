...
class NetworkZoneRecordsGet200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[StrictStr]] = Field(default=None, description="List of endpoints", json_schema_extra={"examples": [["/1.0/network-zones/example.net/records/foo", "/1.0/network-zones/example.net/records/bar"]]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkZoneRecordsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkZoneRecordsGet200Response from a dict"""
        if obj is None:
            return None
