...
class StoragePoolVolumesTypeSnapshotsGetRecursion1200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[StorageVolumeSnapshot]] = Field(default=None, description="List of storage volume snapshots")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [StorageVolumeSnapshot.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
