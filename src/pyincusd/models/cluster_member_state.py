...
class ClusterMemberState(BaseModel):
    ...
    ClusterMemberState
    """ # noqa: E501
    storage_pools: Optional[Dict[str, StoragePoolState]] = None
    sysinfo: Optional[ClusterMemberSysInfo] = None
    __properties: ClassVar[List[str]] = ["storage_pools", "sysinfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in storage_pools (dict)
        _field_dict = {}
        ...
        if self.sysinfo:
            _dict['sysinfo'] = self.sysinfo.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "storage_pools": dict(
                (_k, StoragePoolState.from_dict(_v))
                for _k, _v in obj["storage_pools"].items()
            )
            if obj.get("storage_pools") is not None
            else None,
            "sysinfo": ClusterMemberSysInfo.from_dict(obj["sysinfo"]) if obj.get("sysinfo") is not None else None
        })
        return _obj
