...
class SystemKernelStateMemory(BaseModel):
    """
    SystemKernelStateMemory
    """ # noqa: E501
    zram_swap: Optional[SystemKernelStateMemoryZramSwap] = None
    __properties: ClassVar[List[str]] = ["zram_swap"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of zram_swap
        if self.zram_swap:
            _dict['zram_swap'] = self.zram_swap.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "zram_swap": SystemKernelStateMemoryZramSwap.from_dict(obj["zram_swap"]) if obj.get("zram_swap") is not None else None
        })
        return _obj
