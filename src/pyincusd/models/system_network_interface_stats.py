...
class SystemNetworkInterfaceStats(BaseModel):
    """
    SystemNetworkInterfaceStats
    """ # noqa: E501
    rx_bytes: Optional[StrictInt] = None
    rx_errors: Optional[StrictInt] = None
    tx_bytes: Optional[StrictInt] = None
    tx_errors: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["rx_bytes", "rx_errors", "tx_bytes", "tx_errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rx_errors": obj.get("rx_errors"),
            "tx_bytes": obj.get("tx_bytes"),
            "tx_errors": obj.get("tx_errors")
        })
        return _obj
