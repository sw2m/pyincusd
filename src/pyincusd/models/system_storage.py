...
class SystemStorage(BaseModel):
    ...
    SystemStorage
    """ # noqa: E501
    config: Optional[SystemStorageConfig] = None
    state: Optional[SystemStorageState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": SystemStorageConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": SystemStorageState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
