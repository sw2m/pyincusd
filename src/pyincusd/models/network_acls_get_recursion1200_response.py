...
class NetworkAclsGetRecursion1200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[NetworkACL]] = Field(default=None, description="List of network ACLs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [NetworkACL.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
