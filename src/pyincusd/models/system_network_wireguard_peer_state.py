...
class SystemNetworkWireguardPeerState(BaseModel):
    """
    SystemNetworkWireguardPeerState
    """ # noqa: E501
    allowed_ips: Optional[List[StrictStr]] = None
    endpoint: Optional[StrictStr] = None
    latest_handshake: Optional[StrictStr] = None
    persistent_keepalive: Optional[StrictStr] = None
    public_key: Optional[StrictStr] = None
    stats: Optional[SystemNetworkInterfaceStats] = None
    __properties: ClassVar[List[str]] = ["allowed_ips", "endpoint", "latest_handshake", "persistent_keepalive", "public_key", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latest_handshake": obj.get("latest_handshake"),
