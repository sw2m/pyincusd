...
class SystemKernelConfigPCISRIOV(BaseModel):
    """
    SystemKernelConfigPCISRIOV
    """ # noqa: E501
    pci_address: Optional[StrictStr] = None
    vf_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["pci_address", "vf_count"]
