...
class InitPreseed(BaseModel):
    ...
    InitPreseed
    """ # noqa: E501
    certificates: Optional[List[CertificatesPost]] = Field(default=None, description="Certificates to add  API extension: init_preseed_certificates.")
    ...
    storage_volumes: Optional[List[InitStorageVolumesProjectPost]] = Field(default=None, description="Storage Volumes to add  API extension: init_preseed_storage_volumes.")
