...
class SystemNetworkWireguardState(BaseModel):
    """
    SystemNetworkWireguardState
    """ # noqa: E501
    listening_port: Optional[StrictInt] = None
    peers: Optional[List[SystemNetworkWireguardPeerState]] = None
    public_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["listening_port", "peers", "public_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "peers": [SystemNetworkWireguardPeerState.from_dict(_item) for _item in obj["peers"]] if obj.get("peers") is not None else None,
