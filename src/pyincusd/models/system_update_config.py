...
class SystemUpdateConfig(BaseModel):
    ...
    SystemUpdateConfig
    """ # noqa: E501
    auto_reboot: Optional[StrictBool] = None
    channel: Optional[StrictStr] = None
    check_frequency: Optional[StrictStr] = None
    maintenance_windows: Optional[List[SystemUpdateMaintenanceWindow]] = None
    __properties: ClassVar[List[str]] = ["auto_reboot", "channel", "check_frequency", "maintenance_windows"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.maintenance_windows:
            for _item_maintenance_windows in self.maintenance_windows:
                _items.append(_item_maintenance_windows.to_dict() if _item_maintenance_windows is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auto_reboot": obj.get("auto_reboot"),
            "channel": obj.get("channel"),
            "check_frequency": obj.get("check_frequency"),
            "maintenance_windows": [SystemUpdateMaintenanceWindow.from_dict(_item) for _item in obj["maintenance_windows"]] if obj.get("maintenance_windows") is not None else None
        })
        return _obj
