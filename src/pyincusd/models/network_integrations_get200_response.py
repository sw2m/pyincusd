...
class NetworkIntegrationsGet200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[StrictStr]] = Field(default=None, description="List of endpoints", json_schema_extra={"examples": [["/1.0/network-integrations/region2", "/1.0/network-integrations/region3"]]})
