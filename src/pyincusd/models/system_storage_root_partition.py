...
class SystemStorageRootPartition(BaseModel):
    """
    SystemStorageRootPartition
    """ # noqa: E501
    available_in_bytes: Optional[StrictInt] = None
    size_in_bytes: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["available_in_bytes", "size_in_bytes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "available_in_bytes": obj.get("available_in_bytes"),
