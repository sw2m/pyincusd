...
class NetworkPeerGetRecursion1200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[NetworkPeer]] = Field(default=None, description="List of network peers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [NetworkPeer.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
