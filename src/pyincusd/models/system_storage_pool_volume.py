...
class SystemStoragePoolVolume(BaseModel):
    """
    SystemStoragePoolVolume
    """ # noqa: E501
    name: Optional[StrictStr] = None
    quota_in_bytes: Optional[StrictInt] = None
    usage_in_bytes: Optional[StrictInt] = None
    use: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "quota_in_bytes", "usage_in_bytes", "use"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "quota_in_bytes": obj.get("quota_in_bytes"),
            "usage_in_bytes": obj.get("usage_in_bytes"),
            "use": obj.get("use")
        })
        return _obj
