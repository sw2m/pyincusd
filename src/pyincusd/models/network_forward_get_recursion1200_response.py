...
class NetworkForwardGetRecursion1200Response(BaseModel):
    """
    Sync response
    """ # noqa: E501
    metadata: Optional[List[NetworkForward]] = Field(default=None, description="List of network address forwards")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [NetworkForward.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
