...
from pyincusd.configuration import Configuration
from pyincusd.api_response import ApiResponse, T as ApiResponseT
import pyincusd.models
from pyincusd import rest
from pyincusd.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pyincusd.models, klass)
