...
------------ | ------------- | ------------- | -------------
**aliases** | [**List[ImageAlias]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/ImageAlias.md) | Aliases to add to the image  API extension: image_create_aliases | [optional] 
...
**source** | [**ImagesPostSource**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/ImagesPostSource.md) |  | [optional] 
