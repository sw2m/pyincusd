...
------------ | ------------- | ------------- | -------------
**aliases** | [**List[ImageAlias]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/ImageAlias.md) | Aliases to add to the image  API extension: image_create_aliases | [optional] 
...
**format** | **str** | Type of image format  API extension: instance_publish_split | [optional] 
...
**source** | [**ImagesPostSource**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/ImagesPostSource.md) |  | [optional] 
