...
**partitions** | [**List[ResourcesStorageDiskPartition]**](https://github.com/anonhostpi/pyincusd/blob/v7.3.0/docs/ResourcesStorageDiskPartition.md) | List of partitions | [optional] 
