...
**partitions** | [**List[ResourcesStorageDiskPartition]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/ResourcesStorageDiskPartition.md) | List of partitions | [optional] 
