...
**firewall** | **str** | Current firewall driver  API extension: firewall_driver | [optional] 
**kernel** | **str** | OS kernel name | [optional] 
**kernel_architecture** | **str** | OS kernel architecture | [optional] 
**kernel_features** | **Dict[str, str]** | Map of kernel features that were tested on startup  API extension: kernel_features | [optional] 
**kernel_version** | **str** | Kernel version | [optional] 
**lxc_features** | **Dict[str, str]** | Map of LXC features that were tested on startup  API extension: lxc_features | [optional] 
**os_name** | **str** | Name of the operating system (Linux distribution)  API extension: api_os | [optional] 
**os_version** | **str** | Version of the operating system (Linux distribution)  API extension: api_os | [optional] 
**project** | **str** | Current project name  API extension: projects | [optional] 
**server** | **str** | Server implementation name | [optional] 
**server_clustered** | **bool** | Whether the server is part of a cluster  API extension: clustering | [optional] 
**server_event_mode** | **str** | Mode that the event distribution subsystem is operating in on this server. Either \&quot;full-mesh\&quot;, \&quot;hub-server\&quot; or \&quot;hub-client\&quot;.  API extension: event_hub | [optional] 
**server_name** | **str** | Server hostname  API extension: clustering | [optional] 
...
**storage_supported_drivers** | [**List[ServerStorageDriverInfo]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/ServerStorageDriverInfo.md) | List of supported storage drivers | [optional] 
