...
------------ | ------------- | ------------- | -------------
**addresses** | [**List[InstanceStateNetworkAddress]**](https://github.com/anonhostpi/pyincusd/blob/v7.2.0/docs/InstanceStateNetworkAddress.md) | List of IP addresses | [optional] 
**counters** | [**InstanceStateNetworkCounters**](https://github.com/anonhostpi/pyincusd/blob/v7.2.0/docs/InstanceStateNetworkCounters.md) |  | [optional] 
