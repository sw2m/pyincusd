...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[NetworkAllocations]**](https://github.com/anonhostpi/pyincusd/blob/v7.2.0/docs/NetworkAllocations.md) | List of network allocations used by a consuming entity | [optional] 
