...
------------ | ------------- | ------------- | -------------
**storage_pools** | [**Dict[str, StoragePoolState]**](https://github.com/anonhostpi/pyincusd/blob/v7.3.0/docs/StoragePoolState.md) |  | [optional] 
**sysinfo** | [**ClusterMemberSysInfo**](https://github.com/anonhostpi/pyincusd/blob/v7.3.0/docs/ClusterMemberSysInfo.md) |  | [optional] 
