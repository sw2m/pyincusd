...
**interfaces** | [**List[ResourcesUSBDeviceInterface]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/ResourcesUSBDeviceInterface.md) | List of USB interfaces | [optional] 
**product** | **str** | Name of the product | [optional] 
**product_id** | **str** | USB ID of the product | [optional] 
**serial** | **str** | USB serial number  API extension: device_usb_serial. | [optional] 
