...
------------- | ------------- | -------------
[**metadata_configuration_get**](https://github.com/anonhostpi/pyincusd/blob/v7.3.0/docs/DefaultApi.md#metadata_configuration_get) | **GET** /1.0/metadata/configuration | Get the metadata configuration
...
[**MetadataConfigurationGet200Response**](https://github.com/anonhostpi/pyincusd/blob/v7.3.0/docs/MetadataConfigurationGet200Response.md)
