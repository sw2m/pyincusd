...
------------ | ------------- | ------------- | -------------
**address_sizes** | [**ResourcesCPUAddressSizes**](https://github.com/anonhostpi/pyincusd/blob/v7.2.0/docs/ResourcesCPUAddressSizes.md) |  | [optional] 
**cache** | [**List[ResourcesCPUCache]**](https://github.com/anonhostpi/pyincusd/blob/v7.2.0/docs/ResourcesCPUCache.md) | List of CPU caches | [optional] 
**cores** | [**List[ResourcesCPUCore]**](https://github.com/anonhostpi/pyincusd/blob/v7.2.0/docs/ResourcesCPUCore.md) | List of CPU cores | [optional] 
