...
------------ | ------------- | ------------- | -------------
**backups** | [**List[StorageBucketBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/StorageBucketBackup.md) | List of backups. | [optional] 
...
**keys** | [**List[StorageBucketKey]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/StorageBucketKey.md) | List of keys. | [optional] 
