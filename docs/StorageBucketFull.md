...
------------ | ------------- | ------------- | -------------
**backups** | [**List[StorageBucketBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageBucketBackup.md) | List of backups. | [optional] 
...
**keys** | [**List[StorageBucketKey]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageBucketKey.md) | List of keys. | [optional] 
