...
------------ | ------------- | ------------- | -------------
**metadata** | [**Dict[str, InstanceNVRAMVariable]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/InstanceNVRAMVariable.md) | Namespaced UEFI variables | [optional] 
