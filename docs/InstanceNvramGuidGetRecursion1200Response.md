...
------------ | ------------- | ------------- | -------------
**metadata** | [**Dict[str, InstanceNVRAMVariable]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/InstanceNVRAMVariable.md) | Namespaced UEFI variables | [optional] 
