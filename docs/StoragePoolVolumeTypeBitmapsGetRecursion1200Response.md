...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeBitmap]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageVolumeBitmap.md) | List of storage volume bitmaps | [optional] 
