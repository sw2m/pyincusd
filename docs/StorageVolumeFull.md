...
------------ | ------------- | ------------- | -------------
**backups** | [**List[StorageVolumeBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/StorageVolumeBackup.md) | List of backups. | [optional] 
...
**snapshots** | [**List[StorageVolumeSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/StorageVolumeSnapshot.md) | List of snapshots. | [optional] 
**state** | [**StorageVolumeState**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/StorageVolumeState.md) |  | [optional] 
