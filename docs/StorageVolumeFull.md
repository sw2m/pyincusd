...
------------ | ------------- | ------------- | -------------
**backups** | [**List[StorageVolumeBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageVolumeBackup.md) | List of backups. | [optional] 
...
**snapshots** | [**List[StorageVolumeSnapshot]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageVolumeSnapshot.md) | List of snapshots. | [optional] 
**state** | [**StorageVolumeState**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageVolumeState.md) |  | [optional] 
