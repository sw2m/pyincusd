...
**vfs** | [**List[ResourcesNetworkCard]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/ResourcesNetworkCard.md) | List of VFs (as additional Network devices) | [optional] 
