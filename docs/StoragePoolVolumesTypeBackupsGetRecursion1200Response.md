...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageVolumeBackup.md) | List of storage volume backups | [optional] 
