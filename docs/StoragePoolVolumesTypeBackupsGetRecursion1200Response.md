...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageVolumeBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.3.0/docs/StorageVolumeBackup.md) | List of storage volume backups | [optional] 
