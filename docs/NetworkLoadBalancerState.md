...
------------ | ------------- | ------------- | -------------
**backend_health** | [**Dict[str, NetworkLoadBalancerStateBackendHealth]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/NetworkLoadBalancerStateBackendHealth.md) |  | [optional] 
