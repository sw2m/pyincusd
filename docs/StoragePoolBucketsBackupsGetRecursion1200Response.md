...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageBucketBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/StorageBucketBackup.md) | List of storage bucket backups | [optional] 
