...
------------ | ------------- | ------------- | -------------
**metadata** | [**List[StorageBucketBackup]**](https://github.com/anonhostpi/pyincusd/blob/v7.4.0/docs/StorageBucketBackup.md) | List of storage bucket backups | [optional] 
