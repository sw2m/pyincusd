...
**nodes** | [**List[ResourcesMemoryNode]**](https://github.com/anonhostpi/pyincusd/blob/v7.5.1/docs/ResourcesMemoryNode.md) | List of NUMA memory nodes  API extension: resources_v2 | [optional] 
